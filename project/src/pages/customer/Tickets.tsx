...
const Tickets = () => {
  ...
  const { data: tickets, isLoading, error } = useQuery(
    ['customerTickets', statusFilter, priorityFilter],
    () =>
      ticketApi.getCustomerTickets({
    ...
    <div>
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
        ...
        <div className="mt-4 md:mt-0">
          <Link to="/tickets/create" className="btn-primary inline-flex items-center">
      ...
      {isLoading ? (
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            No tickets found. Create a new ticket to get help from our support team.
          </p>
          <Link to="/tickets/create" className="btn-primary inline-flex items-center">
            <Plus className="-ml-1 mr-2 h-5 w-5" />
            Create New Ticket
